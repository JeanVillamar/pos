					...
					<tr>
						...
						<td class="text-center">
							<div class="d-flex justify-content-center">
								<div class="input-group mb-3 mt-2" style="width:130px"> <!-- Reducido el ancho total de 160px a 130px-->
									<span class="input-group-text rounded-start bg-light btnQty" type="btnMin" style="cursor:pointer; width:40px" key="<?php echo $value->id_product ?>">
									...
									<span class="input-group-text rounded-end bg-light btnQty" type="btnMax" style="cursor:pointer; width:40px" key="<?php echo $value->id_product ?>">
						...
						<td>
							<h6 class="text-center my-3 pricePurchase pricePurchase_<?php echo $value->id_product ?>" pricePurchase="
							<?php echo $value->subtotal_sale ?>" originalPricePurchase="<?php echo $original_price ?>">$ 
							<?php echo number_format($value->subtotal_sale,2) ?></h6>
						</td>
